namespace EliteCommodityAnalysis.Abstractions.Overrides
{
    using System;
    ...
    public static class InitializedDateTime
    {
        ...
        public static TimeSpan NowMinusPastDateTime(DateTimeOffset input)
        {
            return DateTimeOffset.UtcNow.Subtract(input.ToUniversalTime());
        }
